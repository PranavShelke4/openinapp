...
function DataCards() {
  return (
    <div className="Data-Cards">
      <div className="card">
        <div className="card-icon" style={{backgroundColor: "rgba(127, 205, 147, 1)"}}>
          ...
          <div className="card-pro-loss">
            ...
            <p className="card-text" id="card-text">+0.5%</p>
          </div>
        </div>
      </div>

      <div className="card">
        <div className="card-icon" style={{backgroundColor: "rgba(222, 191, 133, 1)"}}>
      ...
      <div className="card">
        <div className="card-icon" style={{backgroundColor: "rgba(236, 164, 164, 1)"}}>
      ...
      <div className="card">
        <div className="card-icon" style={{backgroundColor: "rgba(169, 176, 229, 1)"}}>
